...
public class ThirdPersonMovement : MonoBehaviour
{
  ...
  //  [SerializeField] PlayerEffectsSync playerVFXSync;
    ...
    private void MouseRot()
    {
        ...
        //controller.Move((transform.GetChild(0).forward * direction.z * 0.1f));
    }
    ...
    private void BasicMovement()
    {
        ...
        */
        ...
        if (dir.z >= 0.1f)
        {
            Vector3 moveDirection = transform.GetChild(0).forward;
            if (isGrounded)
                velocityXZ += moveDirection.normalized * dir.z * runSpeed * movePenalty * Time.deltaTime * 30f;
            else
                velocityXZ += moveDirection.normalized * dir.z * airControl * movePenalty * Time.deltaTime * 30f;
        }
